							...
							<div class="socials">
								...
								<a href="https://instagram.com/zerah_fx?igshid=OGQ5ZDc2ODk2ZA==" target="_blank" class="socials__link">
									<svg class="icon" width="48" height="49" viewBox="0 0 48 49" xmlns="http://www.w3.org/2000/svg">
										...
										<path fill-rule="evenodd" clip-rule="evenodd" d="M24.0011 20.4619C26.3574 20.4619 28.2678 22.3721 28.2678 24.7286C28.2678 27.0849 26.3574 28.9953 24.0011 28.9953C21.6445 28.9953 19.7344 27.0849 19.7344 24.7286C19.7344 22.3721 21.6445 20.4619 24.0011 20.4619Z"/>
									</svg>
								</a>
							</div>
						</h3>
