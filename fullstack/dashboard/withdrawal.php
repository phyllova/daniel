...
<head>
  ...
  <title>Client Area | <?php echo $_SESSION['name'] ?></title>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                      <div class="col-sm-4">
                        ...
                        <input type="text" name="account_name" class="form-control" id="exampleInputPassword1" value="<?php if($_SESSION['account_name']) { echo $_SESSION['account_name']; } else { echo"N/A"; } ?>" readonly>
                      </div>

                      <div class="col-sm-4">
                        <label for="exampleInputPassword1">Bank Name</label>
                        <input type="text" name="bank" class="form-control" id="exampleInputPassword1" value="<?php if($_SESSION['bank']) { echo $_SESSION['bank']; } else { echo"N/A"; } ?>" readonly>
                      </div>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                      <div class="col-sm-4">
                        ...
                        <input type="text" name="account_name" class="form-control" id="exampleInputPassword1" placeholder="USD">
                      </div>

                      <div class="col-sm-4">
                        <label for="exampleInputPassword1"><i class="nav-icon fas icofont-wallet"></i>Wallet Address</label>
                        <input type="text" name="bank" class="form-control" id="exampleInputPassword1" placeholder="BTC/USDT">
                      </div>

                      <div class="col-sm-4">
                        <label for="exampleInputPassword1"><i class="nav-icon fas icofont-fiat"></i>Token Network</label>
                        <input type="text" name="account_number" class="form-control" id="exampleInputPassword1" placeholder="Network">
                      </div>
                    </div>
