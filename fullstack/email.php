            ...
            <tbody>
                <tr>
                    <td class="esd-email-paddings" valign="top">
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" align="center" width="600" valign="top">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-p20r es-p20l" align="center" style="font-size:0"><a target="_blank"><img class="adapt-img" src="img/UpstableLogoBlack.svg" alt="Image" style="display: block; margin-top: 43px !important;" title="Image" width="200"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                        ...
                        <p style="margin-bottom: 44px;">Thanks for joining Upstable FX,<br> Your account ID is <b><?php echo $_SESSION['reg_client_id']; ?></b><br>Please update your profile details and bank account number on your dashboard after this email verification.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p10b">
                                                                                       <p>For more enquires please contact us; <br>Email: info@upstablefx.com <br>Phone: +(333) 052 39876</p>
                        <p>Regards,<br>Management Upstable FX.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p10b">
