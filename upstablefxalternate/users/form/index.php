	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="<?php echo sysfunc::sanitize_input($_SERVER["PHP_SELF"]);?>" name="form1" id="form1" method="post">
					<center>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn" style="border-radius: 14px">
							...
							<button value="Submit" class="login100-form-btn">
								Login
							</button>
						</div>
					</div>
