			...
			<div class='row'>
				...
				<?php else: ?>
					...
					<div class='col-md-12'>
						...
						<p><strong>Investment Profit:</strong> $<?php echo number_format($client['profitbalance'], 2); ?></p>
						<p><strong>Total Balance:</strong> $<?php echo number_format($client['walletbalance'], 2); ?></p>
									...
									<form method='POST'>
										...
										<div class='form-group'>
											<select type='text' class='form-control' name='type'>
												...
												<option value='tprofit'>Top Profit</option>
											</select>
										</div>
