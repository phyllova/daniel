	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo sysfunc::sanitize_input($_SERVER["PHP_SELF"]);?>" method="post">
					<center>
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
						...
						<input id="inp" class="input100" type="text" name="email">
						<span class="focus-input100" data-placeholder="Email"></span>
					</div>
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn" style="border-radius: 14px">
							<div class="login100-form-bgbtn"></div>
							<button name="submit" value="Reset" class="login100-form-btn">
								Send
							</button>
						</div>
					</div>
